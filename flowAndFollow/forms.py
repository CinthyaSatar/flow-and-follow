...
from flowAndFollow.models import User
...
class EntryForm(FlaskForm):
    entry_type = SelectField('Entry Type', choices=[('log', 'Log'), ('appointment', 'Appointment')], default='log')
    title = StringField('Title', validators=[DataRequired()])
    content = TextAreaField('Content', validators=[DataRequired()])
    date = DateField('Date', validators=[Optional()], format='%Y-%m-%d')  
    entry_type = StringField('Entry Type')
